...
public class CoordinateTransform
{
    ...
    public static string TWD97_To_lonlat(double XValue, double YValue, int Type=2)
    {
        string lonlat = "";
        if (Type == 1)
        {
    ...
    public static List<double> CoordinateStringToCoordinate(string coorstr)
    {
        //PointF pf = new PointF();
        List<double> rt= new List<double>();
        coorstr=coorstr.Trim();
       string[]sarr=  coorstr.Split(',');
        foreach(string nstr in sarr)
        {
            rt.Add(double.Parse(nstr));
        }
